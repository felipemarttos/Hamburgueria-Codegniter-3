<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand logo" href="<?php echo base_url('app/home/index');?>"><i class="fa fa-bullhorn" style="color: #FEEA3A"></i> Comunic</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav pull-right">
                <li <?php echo ($active == "home") ? 'active' : "" ;?>><a href="<?php echo base_url('app/home/index');?>"><i class="fa fa-tachometer" aria-hidden="true"></i> Dashboard</a></li>
                ...
                <li <?php echo ($active == "alterarSenha") ? 'class="active"' : "" ;?>><a href="<?php echo base_url('app/usuarios/alterarSenha');?>"><i class="fa fa-unlock-alt" aria-hidden="true"></i> Alterar Senha</a></li>
