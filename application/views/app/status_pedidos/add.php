<div class="container"  style="margin-top: 20px">
    <div class="panel panel-default painel-personalizado">
        <div class="panel-body">
            <h3>
                ...
                <a href="<?php echo base_url('app/statusPedidos/index');?>" class="btn btn-info pull-right"><i class="fa fa-refresh"></i> <span class="no-mobile">Voltar</span></a>
            </h3>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-body">
                ...
                <?php 
                    if (isset($id) && $id > 0) {
                        echo form_open_multipart('/app/statusPedidos/update', 'class="form-sample"'); 
                        echo '<input type="hidden" name="id" value="'.$id.'" />';
                    } else {
                       echo form_open_multipart('/app/statusPedidos/create', 'class="form-sample"');  
                    }
                ?>
                <div class="row">
                    <div class="col-sm-10">
