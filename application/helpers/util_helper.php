...
if (!function_exists('geraDataTimeBD')) {
...
if (!function_exists('geraDataTimeNormal')) {
...
if (!function_exists('porcentagem_nx')) {
 ...
 if (!function_exists('porcentagem_nnx')) {
...
if (!function_exists('geraValorReais')) {
    /// valores formatados
...
if (!function_exists('geraValorReaisSem')) {
...
if (!function_exists('geraValorBD')) {
...
if (!function_exists('dataTimeExtenso')) {
